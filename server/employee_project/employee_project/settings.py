...
SECRET_KEY = 'django-insecure-bzr0syell^@ytk8u_2=nvi$akkisw*it_^!wou9gnpoo#u($1f'
...
LOGGING = {
    ...
    'handlers': {
        'employee_app_logs_handler': {
            'level': 'DEBUG',
            'class': 'logging.FileHandler',
            'filename': os.path.join(BASE_DIR, 'logs/employee_app.log'),
            "formatter": "verbose",
        },
    ...
    'loggers': {
        'employee_app.views': {
            'handlers': ['employee_app_logs_handler','console'],
            'level': 'DEBUG',
            'propagate': True,
        },
        'account.views': {
